...
## Provider Selection
- Use `msgraph_resource` for the `policies/crossTenantAccessPolicy/default` API; the AzureAD provider does not cover the default policy configuration at the same level.
